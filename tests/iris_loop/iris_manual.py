...
for gamma in [0.1, 0.01, 0.001]:
    Flog.flagged() and flog.write({'start_loop': 298, 'lsn': 28})
    Flog.flagged() and flog.write({'start_loop': 241, 'lsn': 25})
    Flog.flagged() and flog.write({'start_loop': 190, 'lsn': 22})
    Flog.flagged() and flog.write({'start_loop': 145, 'lsn': 19})
    Flog.flagged() and flog.write({'start_loop': 106, 'lsn': 16})
    ...
    Flog.flagged() and flog.write({'end_loop': 106, 'lsn': 17})
    Flog.flagged() and flog.write({'end_loop': 145, 'lsn': 20})
    Flog.flagged() and flog.write({'end_loop': 190, 'lsn': 23})
    Flog.flagged() and flog.write({'end_loop': 241, 'lsn': 26})
    Flog.flagged() and flog.write({'end_loop': 298, 'lsn': 29})
