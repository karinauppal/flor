...
Flog.flagged() and flog.write({'file_path':
    '/Users/karina/flor/tests/iris_loop/iris_annot.py', 'lsn': 0})
from flor import Flog
if Flog.flagged():
...
Flog.flagged() and flog.write({'locals': [{'start_time': flog.serialize(
    start_time)}], 'lineage': 'start_time = time.time()', 'lsn': 28})
Flog.flagged() and flog.write({'locals': [{'start_time': flog.serialize(
    start_time)}], 'lineage': 'start_time = time.time()', 'lsn': 25})
Flog.flagged() and flog.write({'locals': [{'start_time': flog.serialize(
    start_time)}], 'lineage': 'start_time = time.time()', 'lsn': 22})
Flog.flagged() and flog.write({'locals': [{'start_time': flog.serialize(
...
Flog.flagged() and flog.write({'locals': [{'iris': flog.serialize(iris)}],
    'lineage': 'iris = datasets.load_iris()', 'lsn': 29})
Flog.flagged() and flog.write({'locals': [{'iris': flog.serialize(iris)}],
    'lineage': 'iris = datasets.load_iris()', 'lsn': 26})
Flog.flagged() and flog.write({'locals': [{'iris': flog.serialize(iris)}],
    'lineage': 'iris = datasets.load_iris()', 'lsn': 23})
Flog.flagged() and flog.write({'locals': [{'iris': flog.serialize(iris)}],
...
for gamma in [0.1, 0.01, 0.001]:
    Flog.flagged() and flog.write({'start_loop': 360, 'lsn': 31})
    Flog.flagged() and flog.write({'start_loop': 297, 'lsn': 28})
    Flog.flagged() and flog.write({'start_loop': 240, 'lsn': 25})
    ...
    Flog.flagged() and flog.write({'locals': [{'clf': flog.serialize(clf)}],
        'lineage': 'clf = svm.SVC(gamma=gamma, C=100.0)', 'lsn': 33})
    Flog.flagged() and flog.write({'locals': [{'clf': flog.serialize(clf)}],
        'lineage': 'clf = svm.SVC(gamma=gamma, C=100.0)', 'lsn': 30})
    Flog.flagged() and flog.write({'locals': [{'clf': flog.serialize(clf)}],
        'lineage': 'clf = svm.SVC(gamma=gamma, C=100.0)', 'lsn': 27})
    Flog.flagged() and flog.write({'locals': [{'clf': flog.serialize(clf)}],
    ...
    Flog.flagged() and flog.write({'locals': [{'score': flog.serialize(
        score)}], 'lineage': 'score = clf.score(X_te, y_te)', 'lsn': 34})
    Flog.flagged() and flog.write({'locals': [{'score': flog.serialize(
        score)}], 'lineage': 'score = clf.score(X_te, y_te)', 'lsn': 31})
    Flog.flagged() and flog.write({'locals': [{'score': flog.serialize(
        score)}], 'lineage': 'score = clf.score(X_te, y_te)', 'lsn': 28})
    Flog.flagged() and flog.write({'locals': [{'score': flog.serialize(
    ...
    Flog.flagged() and flog.write({'end_loop': 240, 'lsn': 26})
    Flog.flagged() and flog.write({'end_loop': 297, 'lsn': 29})
    Flog.flagged() and flog.write({'end_loop': 360, 'lsn': 32})
