...
Flog.flagged() and flog.write({'locals': [{'scanner': flog.serialize(
    scanner)}], 'lineage': 'scanner = Scanner("log.json")', 'lsn': 25})
Flog.flagged() and flog.write({'locals': [{'scanner': flog.serialize(
    scanner)}], 'lineage': 'scanner = Scanner("log.json")', 'lsn': 22})
Flog.flagged() and flog.write({'locals': [{'scanner': flog.serialize(
...
Flog.flagged() and flog.write({'locals': [{'rows': flog.serialize(rows)}],
    'lineage': 'rows = scanner.to_rows()', 'lsn': 26})
Flog.flagged() and flog.write({'locals': [{'rows': flog.serialize(rows)}],
    'lineage': 'rows = scanner.to_rows()', 'lsn': 23})
Flog.flagged() and flog.write({'locals': [{'rows': flog.serialize(rows)}],
