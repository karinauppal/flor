...
class MyTest(unittest.TestCase):
    ...
    def test_flython_nonexistent_path(self): # example_r does not exist
        ...
        self.assertRaises(FileNotFoundError, lambda: commands.flython.exec_flython(args_flython))
    ...
    def test_cp_nonexistent_path(self): # example_r does not exist
        ...
        self.assertRaises(FileNotFoundError, lambda: flor.commands.cp.exec_cp(args_cp))
    ...
    def test_cp_new_hfile(self):
        ...
        flor.commands.cp.exec_cp(args_cp)
    ...
    def test_no_cp_command(self):
        ...
        flor.commands.flython.exec_flython(args_flython)

        args_flan = Namespace(annotated_file='example_h.py', name='ex')
        self.assertRaises(RuntimeError, lambda: flor.commands.flan.exec_flan(args_flan))
