#/Users/karina/sandbox/example/example_raw.py
...
def fit_and_score_model(solver, alpha, hidden_layer_sizes, test_size):
    ...
    X_tr, X_te, y_tr, y_te = train_test_split(digits.data, digits.target, test_size=GET('test_size', test_size), random_state=100)
