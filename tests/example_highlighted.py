...
if __name__ == '__main__':
    ...
    for alpha in alphas:
        Flog.flagged() and flog.write({'start_loop': 243, 'lsn': 16})
        Flog.flagged() and flog.write({'start_loop': 168, 'lsn': 13})
        Flog.flagged() and flog.write({'start_loop': 106, 'lsn': 10})
        ...
        Flog.flagged() and flog.write({'end_loop': 106, 'lsn': 11})
        Flog.flagged() and flog.write({'end_loop': 168, 'lsn': 14})
        Flog.flagged() and flog.write({'end_loop': 243, 'lsn': 17})
else:
    Flog.flagged() and flog.write({'conditional_fork':
